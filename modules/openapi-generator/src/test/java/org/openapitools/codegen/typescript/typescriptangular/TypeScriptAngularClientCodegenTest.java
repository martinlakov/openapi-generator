...
public class TypeScriptAngularClientCodegenTest {
    ...
    public void toEnumVarName() {
        ...
        codegen.processOpts();
        assertEquals(codegen.toEnumVarName("valid_id", "string"), "ValidId");
        assertEquals(codegen.toEnumVarName("illegal-id+", "string"), "IllegalId");
        ...
        codegen.processOpts();
        assertEquals(codegen.toEnumVarName("valid_id", "string"), "valid_id");
        assertEquals(codegen.toEnumVarName("illegal-id+", "string"), "illegal_id");
    ...
    public void testModelSuffix() {
        ...
        assertEquals(codegen.toModelName("TestName"), "TestNameMySuffix");
        assertEquals(codegen.toModelName("Error"), "ErrorMySuffix");
    }
    ...
    public void testToEnumName() {
        ...
        assertEquals(codegen.toEnumName(makeEnumProperty("TestName")), "TestNameEnum");
        assertEquals(codegen.toEnumName(makeEnumProperty("123")), "_123Enum");
        ...
        codegen.processOpts();
        assertEquals(codegen.toEnumName(makeEnumProperty("TestName")), "TestNameEnum2");

        codegen = new TypeScriptAngularClientCodegen();
        codegen.additionalProperties().put(CodegenConstants.ENUM_NAME_SUFFIX, "");
        codegen.processOpts();
        assertEquals(codegen.toEnumName(makeEnumProperty("TestName")), "TestName");
    }
    ...
    public void testModelFileSuffix() {
        ...
        assertEquals("./testNameMySuffix", codegen.toModelFilename("testName"));
    }
    ...
    public void testOperationIdParser() {
        ...
        org.testng.assertEquals(co1.operationId, "_123testSpecialTags");
    ...
    public void testRemovePrefixSuffix() {
        ...
        // simple noop test
        assertEquals("TestName", codegen.removeModelPrefixSuffix("TestName"));
        ...
        assertEquals("TestName", codegen.removeModelPrefixSuffix("TestName"));
        assertEquals("TestName", codegen.removeModelPrefixSuffix("TestNameGhi"));
        assertEquals("TestNameghi", codegen.removeModelPrefixSuffix("TestNameghi"));
        assertEquals("abcTestName", codegen.removeModelPrefixSuffix("abcTestName"));
        assertEquals("TestName", codegen.removeModelPrefixSuffix("AbcTestName"));
        assertEquals("AbcTestName", codegen.removeModelPrefixSuffix("AbcAbcTestName"));
        assertEquals("TestName", codegen.removeModelPrefixSuffix("TestNameDef"));
        assertEquals("TestNamedef", codegen.removeModelPrefixSuffix("TestNamedef"));
        assertEquals("TestNamedefghi", codegen.removeModelPrefixSuffix("TestNamedefghi"));
        assertEquals("TestNameDefghi", codegen.removeModelPrefixSuffix("TestNameDefghi"));
        assertEquals("TestName", codegen.removeModelPrefixSuffix("TestNameDefGhi"));
    }
    ...
    public void testSchema() {
        ...
        assertEquals(schemaType, "SchemaOne | SchemaTwo | SchemaThree");
    }
    ...
    public void testKebabCasedModelFilenames() {
        ...
        assertEquals(codegen.toModelImport(modelName), "../model/foo-response-links");
        assertEquals(codegen.toModelFilename(modelName), "./foo-response-links");
    }
    ...
    public void testToParamNaming() {
        ...
        codegen.processOpts();
        assertEquals(codegen.toParamName("valid_id"), "validId");
        assertEquals(codegen.toParamName("illegal-id+"), "illegalId");

        codegen = new TypeScriptAngularClientCodegen();
        codegen.additionalProperties().put(CodegenConstants.PARAM_NAMING, CodegenConstants.PARAM_NAMING_TYPE.original.name());
        codegen.processOpts();
        assertEquals(codegen.toParamName("valid_id"), "valid_id");
        assertEquals(codegen.toParamName("illegal-id+"), "illegal_id");
    ...
    public void testCorrectlyProducesImportsWithImportMapping() {
        ...
        assertEquals(codegen.toModelImport(importedModel), importName);
    }
