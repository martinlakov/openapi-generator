...
public abstract class JavaJaxrsBaseTest {
    ...
    static protected AbstractJavaJAXRSServerCodegen codegen;
    ...
    public void testAddOperationToGroupUseTagsTrue() throws IOException {
        ...
        assertEquals(tag0File.getTemplateData().get("baseName"), "Tag0");
        assertEquals(tag0File.getTemplateData().get("commonPath"), "");
        List<CodegenOperation> tag0 = getOperationsList(tag0File.getTemplateData());
        assertEquals(tag0.size(), 2);
        ...
        assertEquals(tag1File.getTemplateData().get("commonPath"), "/group1/op1");
        List<CodegenOperation> tag1 = getOperationsList(tag1File.getTemplateData());
        assertEquals(tag1.size(), 1);
        ...
        assertEquals(tag2File.getTemplateData().get("commonPath"), "");
        List<CodegenOperation> tag2 = getOperationsList(tag2File.getTemplateData());
        assertEquals(tag2.size(), 2);
        ...
        assertEquals(defaultFile.getTemplateData().get("commonPath"), "/group3/op4");
        List<CodegenOperation> noTag = getOperationsList(defaultFile.getTemplateData());
        assertEquals(noTag.size(), 1);
        ...
        assertEquals(group5File.getTemplateData().get("commonPath"), "");
        List<CodegenOperation> group5 = getOperationsList(group5File.getTemplateData());
        assertEquals(group5.size(), 2);
    ...
    public void testAddOperationToGroupUseTagsFalse() throws Exception {
        ...
        assertEquals(tag0File.getTemplateData().get("baseName"), "default");
        assertEquals(tag0File.getTemplateData().get("commonPath"), "");
        List<CodegenOperation> tag0 = getOperationsList(tag0File.getTemplateData());
        assertEquals(tag0.size(), 2);
        ...
        assertEquals(group1File.getTemplateData().get("baseName"), "group1");
        assertEquals(group1File.getTemplateData().get("commonPath"), "/group1");
        ...
        assertEquals(group2File.getTemplateData().get("baseName"), "group2");
        assertEquals(group2File.getTemplateData().get("commonPath"), "/group2/op3");
        ...
        assertEquals(group3File.getTemplateData().get("baseName"), "group3");
        assertEquals(group3File.getTemplateData().get("commonPath"), "/group3/op4");
        List<CodegenOperation> group3 = getOperationsList(group3File.getTemplateData());
        assertEquals(group3.size(), 1);
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group5File = TestUtils.getTemplateBasedFile(generator, output, "src/gen/java/org/openapitools/api/Group5Api.java");
        assertEquals(group5File.getTemplateData().get("baseName"), "group5");
        assertEquals(group5File.getTemplateData().get("commonPath"), "/group5/op7");
        List<CodegenOperation> group5 = getOperationsList(group5File.getTemplateData());
        assertEquals(group5.size(), 1);
        ...
        assertEquals(group6File.getTemplateData().get("baseName"), "group6");
        assertEquals(group6File.getTemplateData().get("commonPath"), "/group6/op8");
        List<CodegenOperation> group6 = getOperationsList(group6File.getTemplateData());
        assertEquals(group6.size(), 1);
    ...
    private void assertOperation(CodegenOperation op, String expectedBasename, String expectedPath, boolean expectedSubResourceOp) {
        assertEquals(op.path, expectedPath);
        assertEquals(op.baseName, expectedBasename);
        assertEquals(op.subresourceOperation, expectedSubResourceOp);
    }
