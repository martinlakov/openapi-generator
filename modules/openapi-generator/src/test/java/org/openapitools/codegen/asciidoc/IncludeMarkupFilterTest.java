...
public class IncludeMarkupFilterTest extends LambdaTest {
    ...
    public void testIncludeMarkupFilterDoesNotIncludeMissingFile() {
        ...
        assertTrue(result.contains("// markup not found, no include::{specDir}not.an.existing.file.adoc[opts=optional]"),
    ...
    public void testIncludeMarkupFilterFoundFileOk() throws IOException {
        ...
        assertTrue(result.contains("include::{specDir}"+tempFile.getName()+"[opts=optional]"), "unexpected filtered: " + result);
    }
