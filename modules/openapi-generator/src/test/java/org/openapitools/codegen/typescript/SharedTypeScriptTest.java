...
public class SharedTypeScriptTest {
    ...
    private void checkAPIFile(List<File> files, String apiFileName) throws IOException {
        ...
        assertTrue(!apiFileContent.contains("import { GetCustomer200Response | PersonWrapper }"));
        assertEquals(StringUtils.countMatches(apiFileContent,"import { PersonWrapper }"),1);
        assertEquals(StringUtils.countMatches(apiFileContent,"import { GetCustomer200Response }"),1);
    }
    ...
    public void oldImportsStillPresentTest() throws IOException {
        ...
        assertTrue(apiFileContent.contains("import { Category }"));
        assertTrue(apiFileContent.contains("import { Tag }"));
    ...
    */
    ...
    public void toModelImportMapTest() {
        ...
        for (Map.Entry<String, String[]> entry : types.entrySet()) {
            ...
            Arrays.sort(mapped);
            assertEquals(mapped, entry.getValue());
        }
    }
}
