...
public class URLPathUtilsTest {
    ...
    public void testDefaultValues() {
        ...
        assertEquals(serverURL.getHost(), "localhost");
        assertEquals(serverURL.getPort(), -1);
        assertEquals(serverURL.getPath(), "");
        assertEquals(URLPathUtils.getScheme(serverURL, null), "http");
        assertEquals(URLPathUtils.getPort(serverURL, 8080), "8080");
        assertEquals(URLPathUtils.getPort(serverURL, "8081"), "8081");
        assertEquals(URLPathUtils.getPath(serverURL, "/abc"), "/abc");
    }
    ...
    public void testUrl() {
        ...
        assertEquals(serverURL.getHost(), "abcdef.xyz");
        assertEquals(serverURL.getPort(), 9999);
        assertEquals(serverURL.getPath(), "/some/path");
        assertEquals(URLPathUtils.getScheme(serverURL, null), "https");
        assertEquals(URLPathUtils.getPort(serverURL, 8080), "9999");
        assertEquals(URLPathUtils.getPort(serverURL, "8081"), "9999");
        assertEquals(URLPathUtils.getPath(serverURL, "/abc"), "/some/path");
    }
    ...
    public void testSanitizeUrl() {
        ...
        for (String[] t:testData) {
            ...
            assertEquals(URLPathUtils.getServerURL(openAPI, null).toString(), t[1]);
        }
    }
    ...
    public void testGetServerURLWithVariables() {
        ...
        assertEquals(URLPathUtils.getServerURL(s1, null).toString(), "http://localhost:8080/");
        ...
        assertEquals(URLPathUtils.getServerURL(s2, null).toString(), "http://v1.test.me/v1");
        ...
        assertEquals(URLPathUtils.getServerURL(s3, null).toString(), "http://localhost:8080/v4");
        ...
        assertEquals(URLPathUtils.getServerURL(s4, null).toString(), "http://91.161.147.64/prd");
        ...
        assertEquals(URLPathUtils.getServerURL(s5, null).toString(), "https://api.stats.com/france");

        Server s6 = new Server().url("https://api.example.com/{wrong}");
        assertEquals(URLPathUtils.getServerURL(s6, null).toString(), "https://api.example.com/");

        Server s7 = new Server().url("https://api.example.com/{wrong}").variables(new ServerVariables());
        assertEquals(URLPathUtils.getServerURL(s7, null).toString(), "https://api.example.com/");
        ...
        assertEquals(URLPathUtils.getServerURL(s8, null).toString(), "https://api.example.com/");
        ...
        assertEquals(URLPathUtils.getServerURL(s9, null).toString(), "https://another-user.example.com/v1");
    }
    ...
    public void testGetServerURLWithVariablesAndUserOverrides() {
        ...
        assertEquals(URLPathUtils.getServerURL(s1, new HashMap<String, String>() {{ put("port", "1234"); }}).toString(), "http://localhost:1234/");

        Server s2 = new Server().url("http://{version}.test.me/{version}").variables(
                serverVariables("version", "v1")
        );
        assertEquals(URLPathUtils.getServerURL(s2, new HashMap<String, String>() {{ put("version", "v2" ); }}).toString(), "http://v2.test.me/v2");
        ...
        assertEquals(URLPathUtils.getServerURL(s3, new HashMap<String, String>() {{ put("port", "5678"); }}).toString(), "http://localhost:5678/v4");
        ...
        assertEquals(URLPathUtils.getServerURL(s4, new HashMap<String, String>() {{ put("targetEnv", "int" ); }}).toString(), "http://91.161.147.64/int");
        ...
        assertEquals(URLPathUtils.getServerURL(s5, new HashMap<String, String>() {{ put("country1", "italy" ); }}).toString(), "https://api.stats.com/italy");

        Server s6 = new Server().url("https://api.example.com/{wrong}");
        assertEquals(URLPathUtils.getServerURL(s6, new HashMap<String, String>() {{ put("port", "8080" ); }}).toString(), "https://api.example.com/");

        Server s7 = new Server().url("https://api.example.com/{wrong}").variables(new ServerVariables());
        assertEquals(URLPathUtils.getServerURL(s7, new HashMap<String, String>() {{ put("", "8080" ); }}).toString(), "https://api.example.com/");

        Server s8 = new Server().url("https://api.example.com/{wrong}").variables(
                serverVariables("other", "something")
        );
        assertEquals(URLPathUtils.getServerURL(s8, new HashMap<String, String>() {{ put("something", "other" ); }}).toString(), "https://api.example.com/");
        ...
        assertEquals(URLPathUtils.getServerURL(s9, new HashMap<String, String>() {{
            put("version", "v2" );
            put("user", "jim");
    ...
    public void useDefaultUrlWhenServerUrlIsNull() {
        ...
        assertEquals(serverURL.toString(), "http://localhost");
    }
}
