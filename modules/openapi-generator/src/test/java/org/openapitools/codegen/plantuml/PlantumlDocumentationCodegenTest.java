...
public class PlantumlDocumentationCodegenTest {
    ...
    public void simpleEntityTest() {
        ...
        assertEquals(fieldList.size(), 2, "size of field list");

        Map<String, Object> firstField = (Map<String, Object>)fieldList.get(0);

        assertEquals((String)firstField.get("name"), "id");
        assertTrue((boolean)firstField.get("isRequired"));
        assertEquals((String)firstField.get("dataType"), "Long");
    }
    ...
    public void listFieldTest() {
        ...
        assertEquals((String)tagsField.get("dataType"), "List<String>");
    }
    ...
    public void inheritedEntitiesTest() {
        ...
        List<Object> entityList = getList(objs, "entities");
        assertEquals(entityList.size(), 2, "size of entity list");
        ...
        assertEquals(inheritanceList.size(), 1, "size of inheritance list");

        Map<String, String> firstInheritance = (Map<String, String>)inheritanceList.get(0);
        assertEquals(firstInheritance.get("parent"), "Parent");
        assertEquals(firstInheritance.get("child"), "Child");
    }
    ...
    public void aggregatedEntitiesTest() {
        ...
        List<Object> entityList = getList(objs, "entities");
        assertEquals(entityList.size(), 3, "size of entity list");

        Map<String, Object> parentEntity = getEntityFromList("Parent", entityList);

        Map<String, Object> nameField = getFieldFromEntity("name", parentEntity);
        assertEquals((String)nameField.get("dataType"), "Simple");

        Map<String, Object> tagsField = getFieldFromEntity("tags", parentEntity);
        assertEquals((String)tagsField.get("dataType"), "List<Tag>");

        List<Object> relationshipList = getList(objs, "relationships");
        assertEquals(relationshipList.size(), 2, "size of relationship list");

        Map<String, Object> firstRelationship = (Map<String, Object>)relationshipList.get(0);
        assertEquals((String)firstRelationship.get("parent"), "Parent");
        assertEquals((String)firstRelationship.get("child"), "Simple");
        assertEquals((String)firstRelationship.get("name"), "name");
        ...
        assertEquals((String)secondRelationship.get("parent"), "Parent");
        assertEquals((String)secondRelationship.get("child"), "Tag");
        assertEquals((String)secondRelationship.get("name"), "tags");
        assertTrue((boolean)secondRelationship.get("isList"));
    }
    ...
    public void sharedIdenticalInlineAllOfTest() {
        ...
        List<Object> relationshipList = getList(objs, "relationships");
        assertEquals(relationshipList.size(), 1, "size of relationship list");

        Map<String, Object> firstRelationship = (Map<String, Object>)relationshipList.get(0);
        assertEquals((String)firstRelationship.get("parent"), "Child");
        assertEquals((String)firstRelationship.get("child"), "Tag");
    }
    ...
    private void assertEntityDoesNotExistsInList(String name, List<?> entityList) {
        ...
        assertEquals(count, 0, "entries with name " + name);
    }
    ...
    private Map<String, Object> getEntityFromList(String name, List<?> entityList) {
        ...
        assertTrue(entity.isPresent(), "entity with name '" + name + "' found in list");
    ...
    private void assertFieldDoesNotExistsInEntity(String name, Map<String, Object> entity) {
        ...
        assertEquals(count, 0, "fields with name " + name);
    }
    ...
    private Map<String, Object> getFieldFromEntity(String name, Map<String, Object> entity) {
        ...
        assertTrue(field.isPresent(), "field with name '" + name + "' found in list");
    ...
    private List<Object> getList(Map<String, Object> objs, String listName) {
        ...
        assertTrue(list instanceof List<?>, "object with name '" + listName + "' in objs map is a list");
